    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-64 bg-black text-white flex flex-col shadow-xl z-20">
        <div className="p-6 border-b border-gray-800 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-lg tracking-tight">Encho WhatsApp</h1>
            <p className="text-xs text-gray-400">Handler</p>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-800">
          <button 
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-gray-900 hover:text-white transition-colors"
          >
            <Settings size={20} />
            Settings
          </button>
