...
import { 
  ...
  FileText, Sparkles, MapPin, ExternalLink
} from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col border-r border-gray-200 min-w-[400px] relative">
              ...
              <div className="p-4 bg-white border-t border-gray-200">
                <div className="flex gap-3">
                  <textarea value={replyText} onChange={(e) => setReplyText(e.target.value)} onKeyDown={handleKeyPress} placeholder="Type a message..." className="flex-1 resize-none border border-gray-300 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 h-20" />
                  <button onClick={handleSend} disabled={!replyText.trim()} className="self-end bg-black text-white p-3 rounded-xl hover:bg-gray-800 disabled:opacity-50 transition-all"><Send size={20} /></button>
                </div>
              </div>
            </div>
